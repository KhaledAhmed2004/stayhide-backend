...
const getServiceAccountCredentials = () => {
    const base64 = config_1.default.googlePlay.serviceAccountBase64;
    if (!base64) {
        throw new ApiError_1.default(http_status_1.default.INTERNAL_SERVER_ERROR, 'GOOGLE_PLAY_SERVICE_ACCOUNT_BASE64 environment variable is not configured');
    }
    try {
        ...
        throw new ApiError_1.default(http_status_1.default.INTERNAL_SERVER_ERROR, 'Failed to parse GOOGLE_PLAY_SERVICE_ACCOUNT_BASE64. Ensure it is a valid Base64 encoded JSON string.');
    }
};
