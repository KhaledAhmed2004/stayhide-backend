...
exports.AskQuestionController = void 0;
...
const submitQuestion = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield ask_question_service_1.AskQuestionService.submitQuestionIntoDB(Object.assign(Object.assign({}, rest), { userId: user.id, userRole: user.role, imageUrl: image }));
...
const getAllQuestions = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield ask_question_service_1.AskQuestionService.getAllQuestionsFromDB(req.query);
    (0, sendResponse_1.default)(res, {
        success: true,
...
const getMyQuestions = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const user = req.user;
    const result = yield ask_question_service_1.AskQuestionService.getMyQuestionsFromDB(user.id, req.query);
    (0, sendResponse_1.default)(res, {
        success: true,
        statusCode: http_status_codes_1.StatusCodes.OK,
...
const answerQuestion = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield ask_question_service_1.AskQuestionService.answerQuestionInDB(questionId, answer);
    (0, sendResponse_1.default)(res, {
        success: true,
        statusCode: http_status_codes_1.StatusCodes.OK,
...
const getQuestionMetrics = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
